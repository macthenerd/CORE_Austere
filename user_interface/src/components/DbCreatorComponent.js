      ...
      <div className="section">
        ...
        <div className="options-grid">
          ...
          <label className="option-item">
            <input
              type="checkbox"
              checked={processingOptions.smartExtraction}
              onChange={(e) => handleOptionChange('smartExtraction', e.target.checked)}
              disabled={isProcessing}
            />
            Smart extraction (classifications, dates, units, analysts)
          </label>
